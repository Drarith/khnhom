            ...
            <div className="bg-foreground rounded-lg shadow-sm border border-primary/10">
                  ...
                  <div className="border-t border-primary/10 pt-6 space-y-6">
                    ...
                    <div>
                      <ProfileFormInput
                        ...
                        fieldWatchValue={watch("username")}
                        label="Username"
                        maxLength={30}
                        hasInput={!!watch("username")}
                      />
                      <p className="mt-2 text-xs text-primary/50">
                        Your unique profile URL: domnor.com/@
                    ...
                    <ProfileFormInput
                      ...
                      fieldWatchValue={watch("displayName")}
                      label="Display Name"
                      maxLength={50}
                      hasInput={!!watch("displayName")}
                    />
                ...
                <div className="p-6 space-y-6">
                  ...
                  <div className="space-y-4">
                    {SOCIAL_PLATFORMS.map((platform) => {
                      const fieldName = platform.key as keyof ProfileFormData;

                      return (
                        <div
                          key={platform.key}
                          className="flex items-center gap-4 p-4 border border-primary/20 rounded-lg hover:border-primary/30 transition-colors"
                        >
                          <div className="shrink-0">{platform.svg}</div>
                          <div className="flex-1">
                            <label className="block text-sm font-medium text-primary/70 mb-2">
                              {platform.label}
                            </label>
                            <div className="flex items-center gap-2">
                              ...
                              <input
                                {...register(fieldName)}
                                type="text"
                                className="flex-1 px-3 py-2 border border-primary/20 bg-foreground rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary/40 outline-none transition-all text-sm text-primary"
                        ...
                        >
                          <div className="flex-1">
                            <input
                              ...
                              className="w-full px-3 py-2 border border-primary/20 bg-foreground rounded-lg mb-2 focus:ring-2 focus:ring-primary/20 focus:border-primary/40 outline-none transition-all text-primary"
                              placeholder="Link title"
                            />
                            <input
                              type="url"
                              defaultValue={link}
                              className="w-full px-3 py-2 border border-primary/20 bg-foreground rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary/40 outline-none transition-all text-primary"
                              placeholder="https://"
                            />
                          </div>
                          <button className="px-3 py-2 text-red-500 hover:bg-red-50 rounded-lg transition-colors">
                            Remove
                          </button>
                        </div>
                      ))}
              ...
              <div className="px-6 py-4 border-t border-primary/10 bg-primary/5">
                <div className="flex justify-end gap-3">
                  ...
                  <button className="px-6 py-2 bg-primary text-foreground rounded-lg hover:bg-primary/90 transition-colors font-medium">
                    Save Changes
                  </button>
                </div>
              </div>
