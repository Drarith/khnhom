      ...
      >
        ...
        <section className=" flex flex-col lg:flex-row items-center justify-between gap-12 mb-24">
          <div className="lg:w-1/2 space-y-8">
            <div className="line inline-flex items-center gap-2 px-3 py-1 rounded-full bg-accent/10 text-accent text-sm font-medium">
            ...
            <p className="line text-lg opacity-80 leading-relaxed max-w-lg">
            ...
            <div className="line flex flex-wrap gap-4 pt-2">
          ...
          <div className="line lg:w-1/2 relative flex justify-center">
        ...
        <section className=" mb-24">
          <div className="text-center mb-16 max-w-2xl mx-auto">
            <h2 className="line text-3xl font-bold mb-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Card 1 */}
            <div className="line group p-8 rounded-3xl bg-zinc-50 dark:bg-zinc-800/30 border border-zinc-100 dark:border-zinc-700/50 hover:shadow-lg transition-all duration-300">
        ...
        <section className=" relative rounded-3xl overflow-hidden bg-zinc-900 text-white below-element min-h-screen">
          ...
          <div className="relative z-10 flex flex-col md:flex-row">
            ...
            <div className=" p-10 md:p-16 md:w-2/3 space-y-6">
              <div className="line inline-block px-3 py-1 bg-white/10 rounded-full text-xs tracking-widest uppercase font-semibold text-accent mb-2">
                My Journey
              </div>
